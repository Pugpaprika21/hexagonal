...
func (m *mstParamsHdrHandler) UpdateParamsHdr(c echo.Context) error {
	var req request.UpdateParamsHdr
	...
	err := m.serv.UpdateParamsHdr(c.Request().Context(), req.UpdateParamsHdrRows)
	if err != nil {
