...
func (u *usersGroupSettingHandler) DeleteUsersSettingGroup(c echo.Context) error {
	var req request.DeleteUsersSettingGroup
	...
	err := u.serv.DeleteUsersSettingGroup(c.Request().Context(), req)
	if err != nil {
